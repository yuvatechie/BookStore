...
namespace CG_BookStoreApi.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public BooksController(CG_BookStoreDbContext context, IConfiguration config)
        {
            _context = context;
            this.config = config;
        }
        ...
        public async Task<ActionResult<Book>> PostBook(Book book)
        {
            ...
            if (_context.Books == null)
          {
              return Problem("Entity set 'CG_BookStoreDbContext.Books'  is null.");
          }
            var b = await _context.Books.FirstOrDefaultAsync(b =>
